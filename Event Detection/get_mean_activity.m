function [pyr_mean_activity,mch_mean_activity,tdt_mean_activity,velo,acc] = get_mean_activity(base,ds_events,event_frame,ex_thresh)
...
for d = 1:length(ds_events)
    ...
    load([base ds_events(d).tag 'activity.mat'])
    load([base ds_events(d).tag 'clustering.mat'])
