function get_partialcorr(combined_info)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                %%%partial correlation workflow
...
for cel = 1:size(decon,1)
    decon_smoothed(cel,:) = smooth(decon(cel,:),10,'boxcar');
end
...
save partialcorr_results partialcorr_results
...
%%repeat with time shifted data (would this still be partial correlation? I
%%think so, just only shift one cell in the pair.

%%summarize results by cell type and across distance